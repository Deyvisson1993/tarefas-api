package com.deyvisson.todo.resources;
...
import com.deyvisson.todo.services.TodoService;
...
public class TodoResource {
	...
	public ResponseEntity<Todo> update(@PathVariable Integer id, @RequestBody Todo obj){
		Todo nweObj = service.update(id, obj);
		return ResponseEntity.ok().body(nweObj);
	}
}
